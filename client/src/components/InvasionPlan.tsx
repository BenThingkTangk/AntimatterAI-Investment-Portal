...
const PHASES = [
  ...
  },
  {
    ...
    color: "#00a7ff",
    icon: Anchor,
    leads: "ΔTOM Voice Agent (standalone), ATOM Red Team, ΔTOM Gaming Console pre-orders, HumanOS B2B",
  ...
  },
  {
    ...
    color: "#b987ff",
    icon: Castle,
    leads: "PhysioPS clinical expansion → enterprise licensing, ΔTOM Quantum Layer",
